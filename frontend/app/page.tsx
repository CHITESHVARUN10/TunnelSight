...
<Link className="inline-flex items-center justify-center gap-2 bg-primary-container hover:bg-primary text-on-primary-container font-headline-sm text-headline-sm px-space-lg py-2.5 rounded-lg transition-colors shadow-sm" href="#" onClick={goAnalyze}>
...
<Link className="inline-flex items-center justify-center gap-2 bg-primary-container hover:bg-primary text-on-primary-container font-headline-sm text-headline-sm px-space-xl py-3 rounded-lg transition-colors shadow-sm" href="#" onClick={goAnalyze}>
<span>Analyze a Capture</span>
<span className="font-code-md text-code-md">→</span>
</Link>
