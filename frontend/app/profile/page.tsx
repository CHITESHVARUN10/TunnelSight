...
<button className="px-space-md py-space-xs rounded bg-surface-container hover:bg-surface-container-high text-on-surface font-label-md text-label-md transition-colors" type="button" onClick={editProfile}>
            Edit Profile
          </button>
...
<button className="font-label-sm text-label-sm text-outline hover:text-on-surface transition-colors uppercase tracking-wider" type="button" onClick={changePreference}>Change</button>
</div>
</div>
{/* Row 2 */}
...
<button className="px-space-md py-space-xs rounded bg-surface-container hover:bg-surface-container-high text-on-surface font-label-md text-label-md transition-colors" type="button" onClick={changePassword}>
              Change Password
            </button>
...
<div className="flex items-center justify-between pt-space-xs">
<button className="px-space-md py-space-xs rounded bg-surface-container hover:bg-surface-container-high text-on-surface font-label-md text-label-md transition-colors" type="button" onClick={manageKeys}>
...
<button className="self-start sm:self-auto px-space-md py-space-xs rounded bg-surface-container hover:bg-surface-container-high text-on-surface font-label-md text-label-md transition-colors flex-shrink-0" type="button" onClick={manageSessions}>
            Manage Sessions
          </button>
</div>
</div>
