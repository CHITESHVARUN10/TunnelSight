...
<div className="flex items-center gap-space-sm flex-wrap self-start xl:self-center"><button className="h-8 px-space-md bg-primary-container hover:bg-tertiary-container text-on-primary-container font-headline-sm text-headline-sm rounded flex items-center gap-space-xs transition-colors shadow-sm focus:outline-none" type="button" onClick={() => switchReportTab('exec')}><span className="material-symbols-outlined text-[16px]">picture_as_pdf</span><span className="">Generate Executive Report</span></button><button className="h-8 px-space-md bg-surface-container hover:bg-surface-container-high text-on-surface font-headline-sm text-headline-sm rounded flex items-center gap-space-xs transition-colors focus:outline-none" type="button" onClick={() => switchReportTab('tech')}><span className="material-symbols-outlined text-[16px]">terminal</span><span className="">Generate Technical Report</span></button><button className="h-8 px-space-sm bg-surface-container-low hover:bg-surface-container text-on-surface-variant hover:text-on-surface rounded flex items-center gap-space-xs transition-colors focus:outline-none" type="button"><span className="material-symbols-outlined text-[16px]">archive</span><span className="font-code-sm text-code-sm">Batch Export (.zip)</span></button><button className="h-8 w-8 bg-surface-container-low hover:bg-surface-container text-on-surface-variant hover:text-on-surface rounded flex items-center justify-center transition-colors focus:outline-none" title="Report Configuration" type="button"><span className="material-symbols-outlined text-[18px]">settings</span></button></div>
</div>
...
<button className="p-space-xs rounded bg-surface-container-low hover:bg-surface-container text-on-surface transition-colors" title="Print Document" type="button">
<span className="material-symbols-outlined text-[16px]">print</span>
</button>
<button className="p-space-xs rounded bg-surface-container-low hover:bg-surface-container text-primary transition-colors" title="Download Signed PDF" type="button">
<span className="material-symbols-outlined text-[16px]">file_download</span>
</button>
<button className="p-space-xs rounded bg-surface-container-low hover:bg-surface-container text-on-surface transition-colors" title="Full Width Preview" type="button">
...
<button className="px-space-md py-space-xs bg-primary-container text-on-primary-container hover:bg-tertiary-container font-headline-sm text-headline-sm rounded flex items-center gap-space-xs transition-colors shadow-sm focus:outline-none" type="button">
<span className="material-symbols-outlined text-[16px]">verified_user</span>
<span>Download Signed PDF</span>
</button>
<button className="px-space-md py-space-xs bg-surface-container hover:bg-surface-container-high text-on-surface font-headline-sm text-headline-sm rounded flex items-center gap-space-xs transition-colors focus:outline-none" type="button">
...
<button className="px-space-md py-space-xs bg-primary-container text-on-primary-container hover:bg-tertiary-container font-headline-sm text-headline-sm rounded flex items-center gap-space-xs transition-colors" type="button">
<span className="material-symbols-outlined text-[16px]">file_download</span>
<span className="">Export Full JSON Forensic Spec</span>
</button>
<button className="px-space-md py-space-xs bg-surface-container hover:bg-surface-container-high text-on-surface font-headline-sm text-headline-sm rounded flex items-center gap-space-xs transition-colors" type="button">
...
<button className="px-space-sm py-space-2xs bg-surface-container-low hover:bg-surface-container text-on-surface font-code-sm text-code-sm rounded flex items-center gap-space-2xs transition-colors" type="button">
...
<button className="px-space-xs py-space-2xs bg-surface-container-highest hover:bg-surface-bright text-primary rounded font-code-sm text-code-sm inline-flex items-center gap-space-2xs focus:outline-none" title="Download Document" type="button">
<span className="material-symbols-outlined text-[14px]">download</span>
<span>Download</span>
</button>
<button className="p-space-2xs hover:bg-surface-container-highest text-on-surface-variant rounded transition-colors focus:outline-none" title="Inspect Document Content" type="button">
...
<td className="py-space-sm px-space-md text-right">
<div className="inline-flex items-center gap-space-xs">
<button className="px-space-xs py-space-2xs bg-surface-container-highest hover:bg-surface-bright text-on-surface rounded font-code-sm text-code-sm inline-flex items-center gap-space-2xs focus:outline-none" title="Download Document" type="button">
<span className="material-symbols-outlined text-[14px]">download</span>
<span>Download</span>
</button>
<button className="p-space-2xs hover:bg-surface-container-highest text-on-surface-variant rounded transition-colors focus:outline-none" title="Inspect Document Content" type="button">
