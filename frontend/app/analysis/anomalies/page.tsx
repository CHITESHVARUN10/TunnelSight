...
<button className="px-space-sm py-space-2xs rounded bg-surface-container hover:bg-surface-container-high text-on-surface transition-colors font-code-sm flex items-center gap-space-2xs" type="button">
