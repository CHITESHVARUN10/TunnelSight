...
<div className="flex items-center gap-space-xs">
<button className="px-space-xs py-space-2xs text-label-sm font-label-sm rounded bg-surface-container text-primary font-medium">Stage Details</button>
<button className="px-space-xs py-space-2xs text-label-sm font-label-sm rounded text-outline hover:text-on-surface transition-colors">Live TTY</button>
</div>
</div>
