...
docker exec -d vpn-gateway tcpdump -i eth0 -w /pcaps/ipsec_modern.pcap esp or udp port 500 or udp port 4500
...
echo "[SUCCESS] PCAP saved to testbed/pcaps/ipsec_modern.pcap!"
